  ...
  GameOfGeister = (function() {
    class GameOfGeister {
      ...
      update_info(e) {
        ...
        var mochi_jikan, mochi_jikan0, mochi_jikan1, byo_yomi, byo_yomi0, byo_yomi1, player_name0, player_name1, win0, lose0, draw0, win1, lose1, draw1, turn, ch;
        msg = e.data;
        console.log(msg);
        $('#message').text(msg);
        if (msg.length < 5) {
        ...
        [msg, mochi_jikan0, mochi_jikan1, byo_yomi0, byo_yomi1, player_name0, player_name1, win0, lose0, draw0, win1, lose1, draw1, turn, ch] = msg.split(',');
